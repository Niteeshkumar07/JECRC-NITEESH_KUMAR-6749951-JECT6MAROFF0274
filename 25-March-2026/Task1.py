...
dpicker = wait.until(EC.visibility_of_element_located((By.XPATH,f'(//div[text()={date}])[1]')))
dpicker.click()
sleep(2)

sflight = wait.until(EC.element_to_be_clickable((By.XPATH,'//h4[text()="Search flights"]/ancestor::button')))
sflight.click()
